...
#define XPAR_MICROBLAZE_0_COMPONENT_NAME bd1_microblaze_0_0
...
#define XPAR_MICROBLAZE_COMPONENT_NAME bd1_microblaze_0_0
...
/* Definitions for peripheral CAN_CONTROLLER_0 */
#define XPAR_CAN_CONTROLLER_0_DEVICE_ID 0
#define XPAR_CAN_CONTROLLER_0_S00_AXI_BASEADDR 0x44A00000
#define XPAR_CAN_CONTROLLER_0_S00_AXI_HIGHADDR 0x44A0FFFF


/* Definitions for peripheral CAN_CONTROLLER_1 */
#define XPAR_CAN_CONTROLLER_1_DEVICE_ID 1
#define XPAR_CAN_CONTROLLER_1_S00_AXI_BASEADDR 0x44A10000
#define XPAR_CAN_CONTROLLER_1_S00_AXI_HIGHADDR 0x44A1FFFF
...
/* Definitions for peripheral AXI_GPIO_ATKFLAG */
#define XPAR_AXI_GPIO_ATKFLAG_BASEADDR 0x40040000
#define XPAR_AXI_GPIO_ATKFLAG_HIGHADDR 0x4004FFFF
#define XPAR_AXI_GPIO_ATKFLAG_DEVICE_ID 0
#define XPAR_AXI_GPIO_ATKFLAG_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_ATKFLAG_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_LATENCY_MONITOR */
#define XPAR_AXI_GPIO_LATENCY_MONITOR_BASEADDR 0x40050000
#define XPAR_AXI_GPIO_LATENCY_MONITOR_HIGHADDR 0x4005FFFF
#define XPAR_AXI_GPIO_LATENCY_MONITOR_DEVICE_ID 1
#define XPAR_AXI_GPIO_LATENCY_MONITOR_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_LATENCY_MONITOR_IS_DUAL 1


/* Definitions for peripheral MB0_DOS_CMD */
#define XPAR_MB0_DOS_CMD_BASEADDR 0x40020000
#define XPAR_MB0_DOS_CMD_HIGHADDR 0x4002FFFF
#define XPAR_MB0_DOS_CMD_DEVICE_ID 2
#define XPAR_MB0_DOS_CMD_INTERRUPT_PRESENT 0
#define XPAR_MB0_DOS_CMD_IS_DUAL 0


/* Definitions for peripheral MB0_FINN_IN */
#define XPAR_MB0_FINN_IN_BASEADDR 0x40030000
#define XPAR_MB0_FINN_IN_HIGHADDR 0x4003FFFF
#define XPAR_MB0_FINN_IN_DEVICE_ID 3
#define XPAR_MB0_FINN_IN_INTERRUPT_PRESENT 0
#define XPAR_MB0_FINN_IN_IS_DUAL 0


/* Definitions for peripheral MB0_GPIO_LED */
#define XPAR_MB0_GPIO_LED_BASEADDR 0x40010000
#define XPAR_MB0_GPIO_LED_HIGHADDR 0x4001FFFF
#define XPAR_MB0_GPIO_LED_DEVICE_ID 4
#define XPAR_MB0_GPIO_LED_INTERRUPT_PRESENT 0
#define XPAR_MB0_GPIO_LED_IS_DUAL 0


/* Definitions for peripheral MB0_GPIO_PB */
#define XPAR_MB0_GPIO_PB_BASEADDR 0x40000000
#define XPAR_MB0_GPIO_PB_HIGHADDR 0x4000FFFF
#define XPAR_MB0_GPIO_PB_DEVICE_ID 5
#define XPAR_MB0_GPIO_PB_INTERRUPT_PRESENT 0
#define XPAR_MB0_GPIO_PB_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_ATKFLAG */
#define XPAR_GPIO_0_BASEADDR 0x40040000
#define XPAR_GPIO_0_HIGHADDR 0x4004FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_ATKFLAG_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_LATENCY_MONITOR */
#define XPAR_GPIO_1_BASEADDR 0x40050000
#define XPAR_GPIO_1_HIGHADDR 0x4005FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_LATENCY_MONITOR_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 1

/* Canonical definitions for peripheral MB0_DOS_CMD */
#define XPAR_GPIO_2_BASEADDR 0x40020000
#define XPAR_GPIO_2_HIGHADDR 0x4002FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_MB0_DOS_CMD_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral MB0_FINN_IN */
#define XPAR_GPIO_3_BASEADDR 0x40030000
#define XPAR_GPIO_3_HIGHADDR 0x4003FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_MB0_FINN_IN_DEVICE_ID
#define XPAR_GPIO_3_INTERRUPT_PRESENT 0
#define XPAR_GPIO_3_IS_DUAL 0

/* Canonical definitions for peripheral MB0_GPIO_LED */
#define XPAR_GPIO_4_BASEADDR 0x40010000
#define XPAR_GPIO_4_HIGHADDR 0x4001FFFF
#define XPAR_GPIO_4_DEVICE_ID XPAR_MB0_GPIO_LED_DEVICE_ID
#define XPAR_GPIO_4_INTERRUPT_PRESENT 0
#define XPAR_GPIO_4_IS_DUAL 0

/* Canonical definitions for peripheral MB0_GPIO_PB */
#define XPAR_GPIO_5_BASEADDR 0x40000000
#define XPAR_GPIO_5_HIGHADDR 0x4000FFFF
#define XPAR_GPIO_5_DEVICE_ID XPAR_MB0_GPIO_PB_DEVICE_ID
...
#define XPAR_MB0_T1_INTERRUPT_MASK 0X000002U
#define XPAR_MICROBLAZE_0_AXI_INTC_MB0_T1_INTERRUPT_INTR 1U
#define XPAR_MAILBOX_0_INTERRUPT_0_MASK 0X000004U
#define XPAR_MICROBLAZE_0_AXI_INTC_MAILBOX_0_INTERRUPT_0_INTR 2U
#define XPAR_CAN_CONTROLLER_0_IRQN_MASK 0X000008U
#define XPAR_MICROBLAZE_0_AXI_INTC_CAN_CONTROLLER_0_IRQN_INTR 3U
#define XPAR_CAN_CONTROLLER_1_IRQN_MASK 0X000010U
#define XPAR_MICROBLAZE_0_AXI_INTC_CAN_CONTROLLER_1_IRQN_INTR 4U
...
#define XPAR_INTC_0_TMRCTR_1_VEC_ID XPAR_MICROBLAZE_0_AXI_INTC_MB0_T1_INTERRUPT_INTR
#define XPAR_INTC_0_MBOX_0_VEC_ID XPAR_MICROBLAZE_0_AXI_INTC_MAILBOX_0_INTERRUPT_0_INTR
#define XPAR_INTC_0_CAN_CONTROLLER_0_VEC_ID XPAR_MICROBLAZE_0_AXI_INTC_CAN_CONTROLLER_0_IRQN_INTR
#define XPAR_INTC_0_CAN_CONTROLLER_1_VEC_ID XPAR_MICROBLAZE_0_AXI_INTC_CAN_CONTROLLER_1_IRQN_INTR

/******************************************************************/


/* Definitions for peripheral MAILBOX_0 IF 0 */
#define XPAR_MAILBOX_0_IF_0_DEVICE_ID 0U
#define XPAR_MAILBOX_0_IF_0_BASEADDR 0x43600000U
#define XPAR_MAILBOX_0_IF_0_USE_FSL 0U
#define XPAR_MAILBOX_0_IF_0_SEND_FSL 0U
#define XPAR_MAILBOX_0_IF_0_RECV_FSL 0U

/* Definition for TestApp ID */
#define XPAR_MAILBOX_0_TESTAPP_ID 0U

/* Definitions for peripheral MAILBOX_0 IF 1 */
#define XPAR_MAILBOX_0_IF_1_DEVICE_ID 1U
...
/* Definitions for peripheral MB0_T0 */
#define XPAR_MB0_T0_DEVICE_ID 0U
#define XPAR_MB0_T0_BASEADDR 0x41C00000U
#define XPAR_MB0_T0_HIGHADDR 0x41C0FFFFU
#define XPAR_MB0_T0_CLOCK_FREQ_HZ 100000000U


/* Definitions for peripheral MB0_T1 */
#define XPAR_MB0_T1_DEVICE_ID 1U
#define XPAR_MB0_T1_BASEADDR 0x41C10000U
#define XPAR_MB0_T1_HIGHADDR 0x41C1FFFFU
#define XPAR_MB0_T1_CLOCK_FREQ_HZ 100000000U


/******************************************************************/

/* Canonical definitions for peripheral MB0_T0 */
#define XPAR_TMRCTR_0_DEVICE_ID 0U
#define XPAR_TMRCTR_0_BASEADDR 0x41C00000U
#define XPAR_TMRCTR_0_HIGHADDR 0x41C0FFFFU
#define XPAR_TMRCTR_0_CLOCK_FREQ_HZ XPAR_MB0_T0_CLOCK_FREQ_HZ
/* Canonical definitions for peripheral MB0_T1 */
#define XPAR_TMRCTR_1_DEVICE_ID 1U
#define XPAR_TMRCTR_1_BASEADDR 0x41C10000U
#define XPAR_TMRCTR_1_HIGHADDR 0x41C1FFFFU
#define XPAR_TMRCTR_1_CLOCK_FREQ_HZ XPAR_MB0_T1_CLOCK_FREQ_HZ
